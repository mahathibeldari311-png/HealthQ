...
import { ActivitySquare, Loader2, Mail, Lock, ShieldAlert } from "lucide-react";
      ...
      <div className="w-full max-w-md space-y-8 z-10">
        ...
        <div className="flex flex-col items-center text-center">
          <div className="flex items-center justify-center w-14 h-14 rounded-2xl bg-teal-500/10 text-teal-400 border border-teal-500/20 shadow-xl shadow-teal-500/5">
            <ActivitySquare className="h-8 w-8 animate-pulse" />
          </div>
          ...
          <p className="mt-2 text-sm text-slate-400 font-medium">
            Sign in to your HealthQ clinical portal
          </p>
        </div>
        ...
        <div className="bg-slate-900/40 backdrop-blur-xl border border-slate-900 p-8 rounded-3xl shadow-2xl space-y-6">
          ...
          <div className="relative flex py-2 items-center">
            ...
            <span className="flex-shrink mx-4 text-xs font-bold text-slate-600 uppercase tracking-wider">Developer Quick Access</span>
            <div className="flex-grow border-t border-slate-800"></div>
          </div>
          <button
            type="button"
            onClick={loginAsGuest}
            className="w-full py-2.5 bg-slate-900 border border-slate-800 hover:border-slate-700 text-xs font-bold text-slate-300 rounded-xl transition-all"
          >
            Explore as Guest (Direct Demo Access)
          </button>
        </div>
        ...
        <p className="text-center text-sm text-slate-500">
          ...
          <Link href="/register" className="font-bold text-teal-400 hover:text-teal-300 transition-colors">
            Sign up now
          </Link>
        </p>
      </div>
